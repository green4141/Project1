		...
		<div class="box">
			...
			<div class="form-block">
				<div class="text-right">
					<a href="${root }board/main?board_id=${board_id}&page=${page}">목록보기</a>
					<c:if test="${readBoardDTO.user == loginUserDTO.idx}" >
						<a href="${root }board/modify?board_id=${board_id}&idx=${idx}&page=${page}">수정하기</a>
						<a href="${root }board/delete?board_id=${board_id}&idx=${idx}">삭제하기</a>
					</c:if>
				</div>
			</div>
		</div>
